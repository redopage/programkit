...
binding, outbox, and retry model is in [Cloudflare email](../integrations/email.md).
...
[Airtable guide](../integrations/airtable.md) before enabling the mode.
...
URL but no secret. See [Connect an agent](../agents/connect.md).
