...
Use [Organizer workflows](../users/organizer-workflows.md) as the product reference and the
[launch checklist](../self-hosting/launch-checklist.md) before opening a self-host to real users.
