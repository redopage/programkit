...
| P6  | **Scheduled jobs**                    | Cloudflare cron for automated due-date reminders (SPK-16) — the only item that _requires_ an unattended send.                                                                                                                                                                                                                                                                                                                                                    |
...
| SPK-16 (1) | Unattended reminder email for an incomplete task near/past due, referencing task + due date, logged in history | P6 cron + reminder job (manual half needs real delivery within ~24 h of the graders' test) |
