...
| SPK-13 | Verified  | Communications supports filtered audiences, custom recipient sets, approval, delivery state, recipient count, history, attempt count, provider ID, and retry visibility.                                                                                                                                                                                                                      |
