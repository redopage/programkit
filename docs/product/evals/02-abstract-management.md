...
Reviewer workspaces stay on same-origin capability links generated by the organizer. The disposable
demo remains useful for repeatable seeded review data while account-backed participant sessions are
