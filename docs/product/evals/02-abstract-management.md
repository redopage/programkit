...
| ABS-02 | Verified       | Every round selects its own reviewer team. Teams are independently editable and persist by round ID.                                                                                      |
...
| ABS-06 | Verified       | Bulk assignment supports a track filter and per-reviewer maximum. Both paths are exercised by tests.                                                                                      |
