...
| **First read** | [Extending ProgramKit](extending-programkit.md)               |
...
Also exercise the [first-event walkthrough](../getting-started/first-event.md) and
[self-host launch checklist](../self-hosting/launch-checklist.md) under the fork's own domains,
