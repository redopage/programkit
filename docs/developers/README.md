...
Read the [repository tour](repository-tour.md) for request flow and boundaries.
...
- Add a product workflow: [Extending ProgramKit](extending-programkit.md#add-a-domain-workflow).
- Add an organizer page: [Extending ProgramKit](extending-programkit.md#add-a-web-surface).
...
- Rebrand or customize the starter: use the [customization map](customizing.md) and replace only
...
[contribution playbook](../agents/contribution-playbook.md) for the implementation sequence, and
[Contributing documentation](../contributing-documentation.md) for audience routing and page
standards.
