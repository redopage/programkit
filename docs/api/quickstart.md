...
policy. The generated [OpenAPI document](openapi.json) exposes the API-key-grantable subset in a
...
Next: read the complete [HTTP API contract](README.md), connect an [agent client](../agents/connect.md),
or review the [self-host launch checklist](../self-hosting/launch-checklist.md).
