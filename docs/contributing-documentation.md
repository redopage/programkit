...
Use the shared [capability status vocabulary](reference/capability-status.md). Prefer “included but
...
[Agent-readable documentation](developers/agent-readable-documentation.md).
