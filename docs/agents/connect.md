...
Use [Self-host troubleshooting](../self-hosting/troubleshooting.md#mcp-client-cannot-connect) for
credentials, origin changes, and ZIP installation. Use the
[`@programkit/agent` protocol reference](../../packages/agent/README.md#troubleshooting) for header,
