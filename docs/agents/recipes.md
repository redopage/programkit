...
Next: [connect an agent](connect.md), inspect the [tool and resource inventory](../../packages/agent/README.md),
or review [Agent Plugins and MCP](../integrations/agent-plugins.md).
