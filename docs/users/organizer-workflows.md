...
[Set up your first event](../getting-started/first-event.md) instead.
...
attendee — before announcing. [Set up your first event](../getting-started/first-event.md) is
that rehearsal, and the [launch checklist](../self-hosting/launch-checklist.md) decides whether
