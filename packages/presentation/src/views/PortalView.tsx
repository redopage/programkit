...
import { Avatar, Button, ProgressBar, StatusBadge } from '../components/ui.tsx'
  ...
  return (
    <div className="min-h-dvh bg-zinc-50">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <section className="flex flex-col gap-6 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/5 sm:p-6 lg:flex-row lg:items-center">
          <div className="flex min-w-0 flex-1 items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-base text-zinc-500 sm:text-sm">
                {participation.roles.join(', ').replaceAll('_', ' ')} · AIE NYC 2026
              </p>
            </div>
          </div>
        ...
        {participation.status === 'invited' ? (
          <section className="rounded-2xl bg-emerald-950 p-5 text-white shadow-xl ring-1 ring-black/10 sm:p-6">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-2xl">
                <h2 className="text-xl font-semibold">Confirm your participation</h2>
                <p className="text-pretty text-base text-emerald-100 sm:text-sm">
