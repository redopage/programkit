...
import type { Campaign } from '@crm-library/core'

import { useWorkspace } from '../lib/workspace.tsx'
import { Button, Drawer, PageHeader, StatusBadge, cx } from '../components/ui.tsx'
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        description="Draft from live CRM segments, review the exact recipient set, and keep approval separate from delivery."
        actions={
      ...
      <div className="flex flex-col gap-6">
        ...
        <dl className="grid gap-4">
          <div>
            ...
            <dd className="text-base capitalize text-zinc-500 sm:text-sm">
              {campaign.audience.replaceAll('_', ' ')}
            </dd>
          </div>
          <div>
        ...
        <div className="rounded-xl bg-amber-50 p-4 ring-1 ring-amber-900/10">
          <p className="text-base font-medium text-amber-900 sm:text-sm">Delivery safety</p>
          <p className="text-pretty text-base text-amber-800 sm:text-sm">
      ...
      >
        ...
        <label className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className="focus-ring resize-y rounded-lg bg-white px-3 py-2 text-base text-zinc-950 shadow-xs ring-1 ring-zinc-950/10 sm:text-sm"
          />
        </label>
      </form>
    </Drawer>
