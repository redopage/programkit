...
description: Diagnose and resolve Program Ops schedule constraints. Use for participant overlaps, room collisions, event-boundary errors, missing records, duration mismatches, capacity warnings, or requests to propose a better placement without directly changing or publishing the schedule.
---
