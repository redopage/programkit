<!-- Canonical: https://programkit.dev/docs/product/program-lifecycle -->
<!-- Markdown: https://programkit.dev/docs/product/program-lifecycle.md -->
...
See [Build and publish a CFP](/docs/guides/build-and-publish-a-cfp.md).
