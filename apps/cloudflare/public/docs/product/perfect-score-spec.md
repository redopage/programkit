<!-- Canonical: https://programkit.dev/docs/product/perfect-score-spec -->
<!-- Markdown: https://programkit.dev/docs/product/perfect-score-spec.md -->

# Perfect-score specification

Companion to [competition-endgame.md](/docs/product/competition-endgame.md). That document says where we are;
...
> [evaluator evidence maps](/docs/product/evals.md) for current implementation status.
