<!-- Canonical: https://programkit.dev/docs/product/evaluator-runbook -->
<!-- Markdown: https://programkit.dev/docs/product/evaluator-runbook.md -->
...
capability assessment remains the [evaluator gap analysis](/docs/product/evaluator-gap-analysis.md); this file
