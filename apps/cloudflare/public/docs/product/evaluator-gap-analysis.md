<!-- Canonical: https://programkit.dev/docs/product/evaluator-gap-analysis -->
<!-- Markdown: https://programkit.dev/docs/product/evaluator-gap-analysis.md -->
...
area lives in [`evals`](/docs/product/evals.md).
...
and remain on the [roadmap](https://forge.smol.ai/andheller/programkit/src/branch/main/ROADMAP.md).
