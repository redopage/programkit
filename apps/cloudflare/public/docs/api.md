<!-- Canonical: https://programkit.dev/docs/api -->
<!-- Markdown: https://programkit.dev/docs/api.md -->
...
The generated [OpenAPI 3.1 document](/docs/api/openapi.json) is the machine-readable contract for the
