<!-- Canonical: https://programkit.dev/docs/users/participant-experiences -->
<!-- Markdown: https://programkit.dev/docs/users/participant-experiences.md -->
...
See [Routes and surfaces](/docs/reference/routes-and-surfaces.md) for the path families and
[Identity and tenancy](/docs/architecture/identity-and-tenancy.md) for the authorization model.
